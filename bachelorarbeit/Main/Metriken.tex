...
\begin{itemize}
    ...
    \item \textit{terms} alle Möglichen Wortkombinationen zur Prüfung, ob eine Behandlung von \textit{null} erwähnt wird. Die genaue Syntax kann bei der Dokumentation von Compromise \footnote{\href{https://observablehq.com/@spencermountain/compromise-match-syntax}{Compromise Dokumentation (Abruf am 04.02.2022}} nachgelesen werden.
