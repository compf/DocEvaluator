...
\end{itemize}
\subsection{Metrik:Kohärenz zwischen Kommentar und Komponentenname}
...
\item \textit{levenshtein\_distance} maximale Levenshtein-Distanz, bei denen zwei Wörter als ähnlich angesehen werden. 
 \end{itemize}
\subsection{Metrik: Verwendung bestimmter Wörter bestrafen}\label{chapter:certain_words}
