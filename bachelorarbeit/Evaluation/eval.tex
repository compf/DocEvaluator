...
\clearpage
 ...
 \begin{figure}
    \begin{subfigure}[b]{0.6\textwidth}
    \centering
\includesvg[scale=0.5,width=\textwidth]{figures/chapter5/log4j_speed_boxplot.svg}
...
\hfill
 \begin{subfigure}[b]{0.6\textwidth}
    \centering
\includesvg[scale=0.5,width=\textwidth]{figures/chapter5/argo_speed_boxplot.svg}
...
\end{subfigure}
 ...
 \begin{subfigure}[b]{0.8\textwidth}
    \centering
\includesvg[scale=0.5,width=\textwidth]{figures/chapter5/eclipse_speed_boxplot.svg}
